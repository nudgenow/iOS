...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: packageName,
            url: "https://github.com/nudgenow/iOS/raw/refs/tags/7.0.6/Nudgecore_iOS.xcframework.zip",
            checksum: "0d8e16085dace9bdd9f80962c5dbe8db1bdccbd35eb8c7ccbeba527d48a813aa"
        ),
        .binaryTarget(
            name: "RiveRuntime",
